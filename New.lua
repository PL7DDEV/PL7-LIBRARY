...
function PL7New:CreateWindow(opts)
    ...
    local function buildSettings()
        ...
        local ug=Instance.new("UIGridLayout"); ug.CellSize=UDim2.new(0.5,-3,0,32); ug.CellPadding=UDim2.new(0,6,0,5); ug.SortOrder=Enum.SortOrder.LayoutOrder; ug.Parent=tGrid
        for _,tn in ipairs(tnames) do
            local th2=PL7New.Themes[tn]
            local tb=mkBtn(tGrid,tn,11,th2.Accent,th2.Background); tb.TextXAlignment=Enum.TextXAlignment.Center
            mkCorner(tb,7); mkStroke(tb,th2.Accent,Win._themeName==tn and 2 or 1,Win._themeName==tn and 0 or 0.5)
            tb.MouseButton1Click:Connect(function()
                playSound("click",0.15,1.1); Win:ApplyTheme(tn)
